...
$(document).ready(function () {
  $("#gorev3 > button").click(function () {
    $('#gorev3 > input[type=text]').val("20% of Earth’s oxygen is produced by the Amazon rainforest");
  });
});
// görev 4
$(document).ready(function() {
...
$(document).ready(function () {
  $("#gorev10 > button").click(function () {
      ...
      $("footer").append(divim);
      divim.addClass("dv");
      $('.dv').prepend('<img class = ".im" src = "check.png" width="100" height="100" style="position: fixed; bottom: 350px; right: 30px;"/>');     
